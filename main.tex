...
\usepackage{graphicx}
% Gorseller icin varsayilan yol ve boyut ayarlari
\graphicspath{{img/}}
...
% Paragraf bicimlendirme (tek tanim)
% Not: Asagida parindent=0pt ve genis parskip kullaniyoruz; burada yinelenmez
\clubpenalty=10000
\widowpenalty=10000
...
\usepackage{colortbl}
% xcolor zaten yukarida yüklendi (table,xcdraw)
% \usepackage[table]{xcolor} % yinelenen yükleme kaldırıldı
...
% Uzun tablo parça boyutu tek noktadan tanimlanacak; yinelenenler kaldirildi
...
% microtype yukarida yüklendi; burada yinelenmiyor
...
% Yardimci kutular ve makrolar
\usepackage[most]{tcolorbox}
\tcbset{left=6pt,right=6pt,top=6pt,bottom=6pt,arc=2pt}
\newtcolorbox{notbox}{colframe=blue!60!black,colback=blue!3!white,title={Not}}
\newtcolorbox{uyaribox}{colframe=red!60!black,colback=red!3!white,title={Uyari}}
\newtcolorbox{ipucubox}{colframe=green!60!black,colback=green!3!white,title={Ipucu}}
\newcommand{\Not}[1]{\begin{notbox}#1\end{notbox}}
\newcommand{\Uyari}[1]{\begin{uyaribox}#1\end{uyaribox}}
\newcommand{\Ipucu}[1]{\begin{ipucubox}#1\end{ipucubox}}

% Standart gorsel ekleme makrosu
...
\cleardoublepage
\listoftables
% Kisaltmalar ve terimler sozlugu
...
\include{data/8}
\include{data/9}
\include{data/9_playbooks}
\include{data/10}
\include{data/10_mappings}
\include{data/11}
\include{data/12}
\include{data/12_lab}
\include{data/13}
\include{data/13_osint}
\include{data/14}

\backmatter
% Ek kaynaklar
\include{data/ek_kaynaklar}
